...
const moduleIcons: Record<string, React.ElementType> = {
    ...
    "authentication-mfa": KeyRound,
    "conditional-access": ShieldCheck,
    "identity-governance": UserCheck,
    "hybrid-identity": RefreshCw,
    "workload-identities": AppWindow,
    "global-secure-access": Globe,
};
                ...
                <div className="max-w-6xl mx-auto px-4">
                    ...
                    >
                        ...
                        <div className="text-center md:text-left">
                            ...
                            <p className="text-gray-400">Microsoft Identity & Access Management Expert</p>
                ...
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    >
                        ...
                        <h2 className="text-3xl font-bold text-white mb-4">
                            Prepare for SC-300 Certification
                        </h2>
                        <p className="text-gray-400 text-lg mb-8 max-w-2xl mx-auto">
                            This training aligns with the Microsoft SC-300 Identity and Access
